    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              "default-src 'self'",
              // Scripts - allow inline for Next.js + external services (PayMe, Pelecard, Stripe, PayPal, reCAPTCHA, Analytics, TikTok)
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://connect.facebook.net https://analytics.tiktok.com https://js.stripe.com https://www.paypal.com https://cdn.payme.io https://*.payme.io https://gateway.pelecard.biz",
              ...
              // Connect - API calls (including Israeli payment providers, TikTok)
              "connect-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://analytics.tiktok.com https://api.cloudinary.com https://res.cloudinary.com https://*.stripe.com https://*.paypal.com https://*.payme.io https://gateway.pelecard.biz https://vercel.com https://*.vercel.com https://*.blob.vercel-storage.com wss:",
