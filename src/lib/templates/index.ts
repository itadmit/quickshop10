...
export const templates: Template[] = [
  ...
  // ============================================
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          features: [
            { id: '1', emoji: '🚚', title: 'משלוח חינם', description: 'בהזמנה מעל ₪299' },
            { id: '2', emoji: '↩️', title: 'החזרות חינם', description: 'עד 30 יום' },
            { id: '3', emoji: '💎', title: 'איכות מובטחת', description: '100% שביעות רצון' },
            { id: '4', emoji: '💬', title: 'תמיכה', description: 'זמינים בכל שאלה' },
          ],
        },
  ...
  // ============================================
  {
    ...
    cssVariables: {
      ...
      '--template-font-body': "'Nunito', sans-serif",
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          features: [
            { id: '1', emoji: '🌿', title: 'טבעי 100%', description: 'ללא כימיקלים מזיקים' },
            { id: '2', emoji: '🐰', title: 'Cruelty Free', description: 'לא נבדק על בעלי חיים' },
            { id: '3', emoji: '♻️', title: 'אריזה ירוקה', description: 'ידידותית לסביבה' },
            { id: '4', emoji: '💖', title: 'תוצאות מוכחות', description: 'אלפי לקוחות מרוצים' },
          ],
        },
  ...
  // ============================================
  {
    ...
    cssVariables: {
      ...
      '--template-font-heading': "'Cormorant Garamond', serif",
      '--template-font-body': "'Lato', sans-serif",
      '--template-radius': '0px',
      '--template-button-style': 'outline',
    },
  ...
  // ============================================
  {
    ...
    cssVariables: {
      ...
      '--template-font-heading': "'Poppins', sans-serif",
      '--template-font-body': "'Inter', sans-serif",
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          features: [
            { id: '1', emoji: '💇‍♀️', title: 'מותגים מובילים', description: 'רק מהטובים בעולם' },
            { id: '2', emoji: '🧴', title: 'מרכיבים איכותיים', description: 'ללא סולפטים וזרחנים' },
            { id: '3', emoji: '✨', title: 'תוצאות מוכחות', description: 'כמו בסלון - בבית' },
            { id: '4', emoji: '🚚', title: 'משלוח מהיר', description: 'עד 3 ימי עסקים' },
          ],
        },
      ...
      },
      {
        ...
        content: { icon: '💬', buttonText: 'לייעוץ', buttonLink: '/contact' },
  ...
  // ============================================
  {
    ...
    cssVariables: {
      ...
      '--template-font-heading': "'Playfair Display', serif",
      '--template-font-body': "'Source Sans Pro', sans-serif",
      '--template-radius': '8px',
      '--template-button-style': 'filled',
    },
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          features: [
            { id: '1', emoji: '🌿', title: 'טרי ואיכותי', description: 'מרכיבים מהחקלאים' },
            { id: '2', emoji: '👨‍🍳', title: 'מתכונים בלעדיים', description: 'פותחו ע"י שפים' },
            { id: '3', emoji: '📦', title: 'אריזה מוקפדת', description: 'שמירה על הטריות' },
            { id: '4', emoji: '⚡', title: 'משלוח מהיר', description: 'עד הבית שלכם' },
          ],
        },
  ...
  // ============================================
  {
    ...
    cssVariables: {
      ...
      '--template-font-heading': "'Space Grotesk', sans-serif",
      '--template-font-body': "'Inter', sans-serif",
      '--template-radius': '8px',
      '--template-button-style': 'filled',
    },
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          features: [
            { id: '1', emoji: '✅', title: 'מוצרים מקוריים', description: 'אחריות יבואן רשמי' },
            { id: '2', emoji: '🛡️', title: 'אחריות מורחבת', description: 'עד 3 שנים' },
            { id: '3', emoji: '🔄', title: 'החלפה קלה', description: '14 ימים ללא שאלות' },
            { id: '4', emoji: '🚀', title: 'משלוח מהיר', description: 'עד יום עסקים אחד' },
          ],
        },
      ...
      },
      {
        ...
        content: { icon: '💬', buttonText: 'לייעוץ חינם', buttonLink: '/contact' },
