...
/**
 * ImageTextPanel - Settings panel for image+text section
 * פאנל הגדרות לסקשן תמונה + טקסט
 */
...
export function ImageTextPanel({ section, onUpdate, onClose, onDelete }: ImageTextPanelProps) {
      ...
      <div className="flex flex-col h-full bg-[var(--editor-bg-primary)]" dir="rtl">
        ...
        <div className="px-4 py-3 border-b border-[var(--editor-border-default)] bg-[var(--editor-bg-secondary)]">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-medium text-[var(--editor-text-primary)]">תמונה + טקסט</h3>
            <ThemeToggle />
          </div>
            ...
            <div className="space-y-0">
              <MiniAccordion title="תמונה" defaultOpen={true}>
                <div className="space-y-3">
                  ...
                  <EditorInput label="תיאור תמונה (alt)" value={(section.content.imageAlt as string) || ''} onChange={(v) => updateContent('imageAlt', v)} />
                </div>
              </MiniAccordion>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 text-xs bg-[var(--editor-bg-primary)] border border-[var(--editor-border-default)] rounded-lg focus:outline-none focus:border-[var(--editor-border-focus)] min-h-[100px]"
                    />
                  </div>
                </div>
              </MiniAccordion>
