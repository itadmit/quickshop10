...
export function LogosSection({ 
  ...
  const mobileColumns = settings.mobileColumns || 3;
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h2 
            className="text-xl md:text-2xl font-display font-light tracking-wide mb-2"
        ...
        {/* Logos Grid */}
        <div className={`grid ${gridCols} gap-8 items-center`} data-logos-grid>
