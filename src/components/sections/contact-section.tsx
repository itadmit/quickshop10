  ...
  return (
    ...
    >
      <div className={`${maxWidthClass} mx-auto`}>
        ...
        <div className={layout === 'split' ? 'grid md:grid-cols-2 gap-12' : ''}>
          
          {/* Contact Info - Zara-style minimalist design */}
          {showInfo && (
            <div className={`space-y-8 ${layout === 'split' ? '' : 'mb-12'}`}>
              ...
              <div className="space-y-6">
                {content.email && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mb-1">אימייל</p>
                    <a href={`mailto:${content.email}`} className="text-sm hover:underline" dir="ltr">
                      {content.email}
                    </a>
                  </div>
                )}
                ...
                {content.phone && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mb-1">טלפון</p>
                    <a href={`tel:${content.phone}`} className="text-sm hover:underline" dir="ltr">
                      {content.phone}
                    </a>
                  </div>
                )}
                ...
                {content.address && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mb-1">כתובת</p>
                ...
                {content.hours && (
                  <div>
                    <p className="text-xs uppercase tracking-widest text-gray-500 mb-1">שעות פעילות</p>
