    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Column 2: Categories */}
          {footerShowCategories && categories.length > 0 && (
        ...
        <div className="pt-8 border-t border-current/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs opacity-40 tracking-wide" data-footer-copyright>
            {footerCopyright || `© ${new Date().getFullYear()} ${storeName}. כל הזכויות שמורות.`}
          </p>
          
          {/* Payment Icons */}
          {footerShowPayments && (
            <div className="flex items-center gap-3 opacity-40" data-footer-payments>
              <VisaIcon />
              <MastercardIcon />
              <AmexIcon />
            </div>
