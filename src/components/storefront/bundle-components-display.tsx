...
export async function BundleComponentsDisplay({ productId, storeSlug }: BundleComponentsDisplayProps) {
  ...
  return (
    <div className="mt-6 mb-6 p-4 bg-gray-50 border border-gray-200">
      <div className="flex items-center gap-2 mb-4">
        <svg className="w-5 h-5 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
        </svg>
        <h3 className="font-semibold text-gray-900">הסט כולל:</h3>
      </div>
            ...
            <div key={component.id} className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <Link 
                  ...
                  className="text-sm font-medium text-gray-900 hover:underline transition-colors line-clamp-1"
                >
                  {product.name}
                </Link>
                {variant && (
