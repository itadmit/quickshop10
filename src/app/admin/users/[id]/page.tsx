...
import { ArrowRight, Mail, User, Calendar, Clock, Store, Shield, CreditCard, ShoppingCart, Edit2 } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 divide-x divide-gray-100 border-b border-gray-100">
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-gray-500">חנויות</p>
              </div>
              <div className="p-4 text-center">
              ...
              <div className="p-4 text-center">
                <p className="text-2xl font-bold text-emerald-600">{formatCurrency(orderStats.totalRevenue)}</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            {ownedStores.length > 0 ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-500">אין חנויות בבעלות המשתמש</p>
              </div>
            )}
          </div>
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1">
        ...
        <p className={`font-medium ${highlight ? 'text-emerald-600' : 'text-gray-900'}`}>{value}</p>
      </div>
    </div>
  );
}
