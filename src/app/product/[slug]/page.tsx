import { getDemoStore, getProductBySlug, getProductsByStore, getProductOptions, getProductVariants } from '@/lib/db/queries';
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const allProducts = await getProductsByStore(store.id, 4);
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="py-6 px-6 border-b border-gray-100">
        <div className="max-w-7xl mx-auto">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>/</li>
            <li><Link href="/#products" className="hover:text-black transition-colors">מוצרים</Link></li>
            <li>/</li>
      ...
      {relatedProducts.length > 0 && (
        <section className="py-20 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <h2 className="font-display text-2xl md:text-3xl text-center mb-4 font-light tracking-[0.1em]">
              אולי יעניין אותך
            </h2>
...
// Generate static paths for products (ISR)
